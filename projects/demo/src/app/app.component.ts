...
import { ThemePickerUtils, ThemePickerService, ThemePickerModel } from '@lowcodeunit/lcu-theme-picker-common';
...
export class AppComponent implements OnInit {
  ...
  constructor(
    ...
    protected themePickerService: ThemePickerService
  ) { }

  public ngOnInit(): void {
    this.Title = ThemePickerUtils.upperThemePicker(this.Title);
    this.Cards = this.themePickerService.getCardData();
    this.resetTheme();
    this.setThemes();
  }
